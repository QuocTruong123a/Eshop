...
<body>
    ...
    <section class="shoping-cart spad ">
        <div class="container ts" data-url="{{route('cart.delete')}}">
            <div class="row">
                <div class="col-lg-12">
                    <div class="shoping__cart__table">
                        <table class="update_cart_url" data-url="{{route('cart.update')}}">
                            <thead>
                                <tr>
                        ...
                        @if(count($cart))
                                <tr class="trs">
                                    <td class="shoping__cart__item">
                                        <img style="width:100px; height:100px;object-fit:object;" src="{{$cart['image']}}" alt="">
                                        <h5>{{($cart['name'])}}</h5>
                                    </td>
                                    ...
                                    <td class="shoping__cart__quantity">
                                        <div class="quantity">
                                            <div class="pro-qty">
                                                <input type="text" name="quantity[]" class="quatity" value="{{$cart['quantity']}}">
                                            </div>
                                        </div>
                                    </td>
                ...
                <div class="col-lg-6">
                    <div class="shoping__checkout">
                        ...
                        <form action="{{route('cart.checkout')}}" method="GET">
                            <button type="submit"  class="site-btn" style="text-align: center">CHECKOUT</button>
                        </form>
  ...
  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p></div>
    ...
    <script >
        function cartupdate(event){
            ...
            let id = $(this).data('id');
            let quatity = $(this).parents('.trs').find('input.quatity').val();
            $.ajax({
                type:"GET",
                url: urlCartupdate,
        ...
        $(function(){
         $(document).on('click','.update',cartupdate);
